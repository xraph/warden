...
const footerLinks = {
  "Getting Started": [
    ...
    { label: "Decision Model", href: "/docs/concepts/decision-model" },
  ],
  Authorization: [
  ...
  Community: [
    ...
    {
      label: "Issues",
      href: "https://github.com/xraph/warden/issues",
      external: true,
    },
    {
      label: "Discussions",
      href: "https://github.com/xraph/warden/discussions",
      external: true,
    },
    {
      label: "Contributing",
      href: "https://github.com/xraph/warden/blob/main/CONTRIBUTING.md",
      external: true,
    },
  ],
};
        ...
        <div className="grid grid-cols-2 gap-8 py-12 sm:py-16 md:grid-cols-5 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="inline-flex items-center gap-2 mb-4">
              <ThemedLogo />
              <span className="font-bold text-lg">Warden</span>
            </Link>
            <p className="text-sm text-fd-muted-foreground leading-relaxed max-w-xs">
              Composable RBAC, ABAC, and ReBAC authorization for Go. Unified
              check API with pluggable stores and tenant isolation.
            </p>
            {/* Social links */}
