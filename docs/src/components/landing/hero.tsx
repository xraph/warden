...
// ─── Mini Authorization Flow Diagram ─────────────────────────
function MiniAuthzDiagram() {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <div className="relative space-y-6 p-4">
        ...
        <div className="flex items-center justify-center gap-0">
          ...
          <FlowNode label="Check" color="indigo" size="sm" delay={0.55} />
          <FlowLine length={24} color="blue" delay={2} />
          <FlowNode label="Decision" color="blue" size="sm" pulse delay={0.7} />
        </div>

        {/* Row 2: RBAC → ABAC → ReBAC */}
        <div className="flex items-center justify-center gap-0">
          <FlowNode
            label="RBAC"
            color="indigo"
        ...
        <div className="flex items-start justify-center">
          <div className="space-y-2.5">
            ...
            >
              ...
              <StatusBadge status="retry" label="no opinion" />
            </motion.div>

            {/* Event 3: graph walked */}
            <motion.div
              initial={{ opacity: 0, x: -10 }}
              animate={{ opacity: 1, x: 0 }}
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
          <FloatingBadge label="RBAC" delay={1.6} />
          <FloatingBadge label="ABAC" delay={1.8} />
          <FloatingBadge label="ReBAC" delay={2.0} />
          <FloatingBadge label="TypeID" delay={2.2} />
        </div>
      </div>
    </motion.div>
  );
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center py-20 sm:py-28 md:py-32">
          ...
          <div className="flex flex-col items-start">
            ...
            >
              ...
              unified behind a single Check API &mdash; tenant-scoped,
              plugin-extensible, and composable.
            </motion.p>
          ...
          {/* Right: Mini Authorization diagram */}
